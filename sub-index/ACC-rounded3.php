                ...
                <table class="min-w-max w-full table-auto">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        ...
                        foreach ($acc as $ac) {
                            $n++;
                            if ($ac['Smajor_id2'] == 1) {
                                $ac['Smajor_id2'] = 'การศึกษาปฐมวัย';
                            } elseif ($ac['Smajor_id2'] == 2) {
                                $ac['Smajor_id2'] = 'การจัดการเรียนรู้ภาษาไทย';
                            } elseif ($ac['Smajor_id2'] == 3) {
                                $ac['Smajor_id2'] = 'การจัดการเรียนรู้ภาษาอังกฤษ';
                            } elseif ($ac['Smajor_id2'] == 4) {
                                $ac['Smajor_id2'] = 'การจัดการเรียนรู้สังคม';
                            } elseif ($ac['Smajor_id2'] == 5) {
                                $ac['Smajor_id2'] = 'การจัดการเรียนรู้คณิตศาสตร์';
                            } elseif ($ac['Smajor_id2'] == 6) {
                                $ac['Smajor_id2'] = 'การจัดการเรียนรู้วิทยาศาสตร์';
                            } else {
                                $ac['Smajor_id2'] = 'คอมพิวเตอร์ศึกษา';
                            };

                            if ($ac['Smajor_id3'] == 1) {
                                $ac['Smajor_id3'] = 'การศึกษาปฐมวัย';
                            } elseif ($ac['Smajor_id3'] == 2) {
                                $ac['Smajor_id3'] = 'การจัดการเรียนรู้ภาษาไทย';
                            } elseif ($ac['Smajor_id3'] == 3) {
                                $ac['Smajor_id3'] = 'การจัดการเรียนรู้ภาษาอังกฤษ';
                            } elseif ($ac['Smajor_id3'] == 4) {
                                $ac['Smajor_id3'] = 'การจัดการเรียนรู้สังคม';
                            } elseif ($ac['Smajor_id3'] == 5) {
                                $ac['Smajor_id3'] = 'การจัดการเรียนรู้คณิตศาสตร์';
                            } elseif ($ac['Smajor_id3'] == 6) {
                                $ac['Smajor_id3'] = 'การจัดการเรียนรู้วิทยาศาสตร์';
                            } else {
                                $ac['Smajor_id3'] = 'คอมพิวเตอร์ศึกษา';
                            };
